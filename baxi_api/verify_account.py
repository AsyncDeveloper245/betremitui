...
from .betremit_exceptions import AgentError, ServerError, TransactionError, BillerError
from .betremit_base import BetremitBase


class VerifyAccount(BetremitBase):
    """
    ...
    def get_service(self, service_type, account_number):
        ...
        return self._handleAccountVerification(endpoint, method, data=data)
